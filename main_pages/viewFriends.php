				...
				<div id="content" style="margin-left:30px;margin-right:30px;">
					<?php
						...
						for ($i=0;$i<$size;$i++)	
						{
							...
							echo $temp['name'];
							echo '<form style="margin-top:5px" action="friendPage.php" method="POST"><button type="submit" class="btn btn-sm btn-primary ">View Profile</button><input type="hidden" name="wall_id" value="'.$temp['user_id'].'"></h4>';
